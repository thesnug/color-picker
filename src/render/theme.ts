...
import type { ThemeMode, ThemeResult } from "../theme.js";
 ...
 */
export function renderThemePreview(themes: readonly ThemeResult[], options: ThemePreviewOptions = {}): string {
...
function modeLabel(mode: ThemeMode | undefined): string {
