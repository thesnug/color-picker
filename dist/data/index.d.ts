...
export type Harmony = "monochromatic" | "analogous" | "complementary" | "split-complementary" | "triadic" | "other";
...
export type ProductColorWithHex = ProductColor & {
    hex: string;
};
/** True when the color has a hex to match, render, or print against. */
export declare function hasHex(color: ProductColor): color is ProductColorWithHex;
